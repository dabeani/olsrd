...
(function(){
  ...
  window._webui_request_log_max = 200; // keep last 200 entries
          ...
          function renderList(q){
            ...
            items.forEach(function(l){
              ...
              r.addEventListener('click', function(){
                try {
                  var pre = document.getElementById('diag-expand-pre'); if (pre) pre.textContent = JSON.stringify(l, null, 2);
                  var modal = document.getElementById('diag-expand-modal'); if (modal) { modal.setAttribute('aria-hidden','false'); modal.style.display='block'; }
                } catch(e) { try{ content.textContent = 'Failed to show details: '+e; } catch(_){} }
              });
